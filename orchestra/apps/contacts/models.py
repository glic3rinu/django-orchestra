...
class Entity(models.Model):
    ...
    type = models.CharField(_("type"), max_length=32,
            choices=settings.ENTITIES_TYPE_CHOICES, default=settings.ENTITIES_DEFAULT_TYPE)
    comments = models.TextField(_("comments"), max_length=256, blank=True)
    language = models.CharField(_("language"), max_length=2,
            choices=settings.ENTITIES_LANGUAGE_CHOICES, default=settings.ENTITIES_DEFAULT_LANGUAGE)
