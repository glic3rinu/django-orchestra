...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mailbox.salt'
        db.add_column(u'mails_mailbox', 'salt',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=96, blank=True),
                      keep_default=False)

        # Adding field 'Mailbox.shadigest'
        db.add_column(u'mails_mailbox', 'shadigest',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mailbox.salt'
        db.delete_column(u'mails_mailbox', 'salt')

        # Deleting field 'Mailbox.shadigest'
        db.delete_column(u'mails_mailbox', 'shadigest')
