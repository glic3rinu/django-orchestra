...
def generate_q19_first_procedure(transactions):
    ...
    for key in transacciones_agrupadas.keys():
        ...
        ordenante.numero_de_registros = num_transactions + num_concepts
    ...
    context_dict = {'fecha_confeccion': datetime.now().strftime("%d%m%y"),
