...
class Monitor(models.Model):
    ...
    resource = models.CharField(max_length=32, choices=settings.RESOURCE_CHOICES)
    monitoring_template = models.CharField(max_length=256, choices=list_files(settings.TEMPLATE_PATHS))
    monitoring_method = PluginField(DaemonMethod, null=True, blank=True, related_name='monitoring_method')
    exceed_trigger_template = models.CharField(max_length=256, blank=True, choices=list_files(settings.TEMPLATE_PATHS))
    exceed_trigger_method = PluginField(DaemonMethod, null=True, blank=True, related_name='exceed_trigger_method')
    recover_trigger_template = models.CharField(max_length=256, blank=True, choices=list_files(settings.TEMPLATE_PATHS))
    ...
    algorithm = models.CharField(max_length=4, choices=settings.ALGORITHM_CHOICES, default=settings.ALGORITHM_DEFAULT)
    period = models.CharField(max_length=1, choices=settings.PERIOD_CHOICES, blank=True)
