...
class SystemUser(models.Model):
    ...
    shell = models.CharField(max_length=23, default=settings.SYSTEM_USERS_DEFAULT_SHELL)
    uid = models.PositiveIntegerField(unique=True)
    primary_group = models.ForeignKey('SystemGroup', default=settings.SYSTEM_USERS_DEFAULT_PRIMARY_GROUP_PK)
    homedir = models.CharField(max_length=255, default=settings.SYSTEM_USERS_DEFAULT_BASE_HOMEDIR)
