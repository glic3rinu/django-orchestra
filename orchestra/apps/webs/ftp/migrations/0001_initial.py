...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FTP'
        db.create_table(u'ftp_ftp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('web', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webs.Web'])),
        ...
        db.send_create_signal(u'ftp', ['FTP'])


    def backwards(self, orm):
        # Deleting model 'FTP'
        db.delete_table(u'ftp_ftp')
