...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'webs_web', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='webs', to=orm['auth.User'])),
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='php5', max_length=32)),
        ...
        db.create_table(m2m_table_name, (
            ...
            ('domain', models.ForeignKey(orm[u'names.domain'], null=False))
        ))
        db.create_unique(m2m_table_name, ['web_id', 'domain_id'])
    ...
    models = {
        ...
        u'webs.web': {
            ...
            'domains': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['names.Domain']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
